        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    scientificinitiationprogramscore = table.Column<int>(name: "scientific_initiation_program_score", type: "INT", nullable: true),
                    institutionalmonitoringprogramscore = table.Column<int>(name: "institutional_monitoring_program_score", type: "INT", nullable: true),
                    juniorenterpriseexperiencescore = table.Column<int>(name: "junior_enterprise_experience_score", type: "INT", nullable: true),
                    projectintechnologicalhotelscore = table.Column<int>(name: "project_in_technological_hotel_score", type: "INT", nullable: true),
                    volunteeringscore = table.Column<float>(name: "volunteering_score", type: "FLOAT", nullable: true),
                    highgradedisciplinescore = table.Column<int>(name: "high_grade_discipline_score", type: "INT", nullable: true),
                    certificationcoursesscore = table.Column<int>(name: "certification_courses_score", type: "INT", nullable: true),
                    highgradecoursesscore = table.Column<int>(name: "high_grade_courses_score", type: "INT", nullable: true),
                    aiprojectsscore = table.Column<int>(name: "ai_projects_score", type: "INT", nullable: true),
                    internshipemploymentscore = table.Column<int>(name: "internship_employment_score", type: "INT", nullable: true),
                    technologycertificationscore = table.Column<int>(name: "technology_certification_score", type: "INT", nullable: true),
                    lowleveltechscore = table.Column<int>(name: "low_level_tech_score", type: "INT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    enrolledinindustry40 = table.Column<ulong>(name: "enrolled_in_industry_4_0", type: "BIT", nullable: true),
                    doesnotmeetrequirements = table.Column<short>(name: "does_not_meet_requirements", type: "SMALLINT", nullable: false),
                    presencial = table.Column<ulong>(type: "BIT", nullable: true),
                    firstmeetingdate = table.Column<DateTime>(name: "first_meeting_date", type: "DATE", nullable: true),
